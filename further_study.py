...
def custom_append(input_list, value):
    ...
    """
    add_position = custom_len(input_list)
    input_list[add_position : add_position] = [value]
    return
...
def custom_extend(input_list, second_list):
    ...
    add_position = custom_len(input_list)
    input_list[add_position : add_position] = second_list
    return
...
def custom_reverse(input_list):
    ...
    for i in range(custom_len(input_list)):
        input_list[i] = new_list[custom_len(input_list) - 1- i]
...
def custom_equality(some_list, another_list):
    ...
    for item in some_list:
        if item == another_list[first_list_count]:
            custom_count += 1
        first_list_count += 1

    if custom_count == first_list_count:
        return True
    else:
        return False
